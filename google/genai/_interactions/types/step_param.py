...
StepParam: TypeAlias = Union[UserInputStepParam, ModelOutputStepParam, ThoughtStepParam, FunctionCallStepParam, CodeExecutionCallStepParam, URLContextCallStepParam, MCPServerToolCallStepParam, GoogleSearchCallStepParam, FileSearchCallStepParam, GoogleMapsCallStepParam, FunctionResultStepParam, CodeExecutionResultStepParam, UrlContextResultStepParam, GoogleSearchResultStepParam, MCPServerToolResultStepParam, FileSearchResultStepParam, GoogleMapsResultStepParam]
