...
__all__ = ["CodeExecution", "GoogleSearch", "McpServer", "UrlContext", "Tool", "ComputerUse", "FileSearch", "GoogleMaps", "RetrievalVertexAISearchConfig", "Retrieval", "Tool"]
...
Tool: TypeAlias = Annotated[
    Union[CodeExecution, GoogleSearch, UrlContext, McpServer], PropertyInfo(discriminator="type")
]
...
Tool: TypeAlias = Annotated[
    Union[Function, CodeExecution, UrlContext, ComputerUse, McpServer, GoogleSearch, FileSearch, GoogleMaps, Retrieval], PropertyInfo(discriminator="type")
]
