...
__all__ = ["ThinkingSummaries", "GenerationConfig", "ToolChoice"]


ThinkingSummaries: TypeAlias = Literal["auto", "none"]
...
class GenerationConfig(BaseModel):
    ...
    tool_choice: Optional[Union[ToolChoiceType, ToolChoiceConfig]] = None
